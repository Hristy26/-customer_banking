...
def main():
    ...
    # ADD YOUR CODE HERE
    cd_balance = float(input("Enter the savings account balance: "))
    cd_interest = float(input("Enter the interest rate for the savings account: "))
    cd_maturity  = int(input("Enter the number of months for the savings account: "))
    ...
    # ADD YOUR CODE HERE
    print(f"Interest earned: ${interest_cd_earned:.2f}")
    print(f"Updated savings account balance with interest earned: ${updated_cd_balance:.2f}")
